...
- Access to the GCP project (e.g., `rle-ruritania-jenn`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-jenn" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-jenn.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-jenn --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-jenn.iam.gserviceaccount.com" \
  --project="rle-ruritania-jenn" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-jenn.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-jenn.
